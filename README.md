...
The normalization transformation can be expressed as 

$L\gets50L/L_{ref}$, $a\gets a-a_{ref}$, and $b\gets b-b_{ref}$,

and the resulting images are shown in the second row of the figure below. It is clearly seen that the color distributions of each classes become very similar after normalization.
...
Labeled images are randomly cropped into images with $100\times 100$ pixels. 
...
Then a max-pooling layer with a $2\times 2$ window and stride 2 is performed and result in downsampling of the image by a factor of 2. 
